...
////graphe de dependance entre features. L'objectif est de ressortir la liste des features utiles
...
char ebx_7_features[32][32]={"fsgsbase","IA32_TSC_ADJUST MSR","sgx","bmi1","hle","avx2","FDP_EXCPTN_ONLY","smep","bmi2","erms","invpcid","rtm","rdt-m/pqm","FPU_CS_and_FPU_DS_deprecated","mpx","rdt-a/pqe","avx512-f","avx512-dq","redseed","adx","smap","avx512ifma","reserved","clflushopt","clwb","pt","avx512-pf","avx512-er","avx512-cd","sha","avx512-bw","avx512-vl"};
...
if(f==NULL){
printf("erreur lorsde l'ouverture du fichier");
exit(1);
}else{
